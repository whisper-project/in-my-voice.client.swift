...
struct PreferenceData {
	...
	static var sizeWhenWhispering: FontSizes.FontSize {
		get { max(defaults.integer(forKey: "size_when_whispering_setting"), FontSizes.minTextSize) }
		set (new) { defaults.setValue(new, forKey: "size_when_whispering_setting") }
	}
	static var sizeWhenListening: FontSizes.FontSize {
		get { max(defaults.integer(forKey: "size_when_listening_setting"), FontSizes.minTextSize) }
		set (new) { defaults.setValue(new, forKey: "size_when_listening_setting") }
	}

	// whether to magnify text
	static var magnifyWhenWhispering: Bool {
		get { defaults.bool(forKey: "magnify_when_whispering_setting") }
		set (new) { defaults.setValue(new, forKey: "magnify_when_whispering_setting") }
	}
	static var magnifyWhenListening: Bool {
		get { defaults.bool(forKey: "magnify_when_listening_setting") }
		set (new) { defaults.setValue(new, forKey: "magnify_when_listening_setting") }
	}
