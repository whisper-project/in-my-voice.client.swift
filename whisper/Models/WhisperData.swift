...
struct WhisperData {
    ...
    static let whisperFullTextUuid = CBUUID(string: "6048A326-0F6F-4744-9C7A-A9796C8C7748")
    static let whisperDiffTextUuid = CBUUID(string: "11A7087A-26F1-47C7-AD1B-6B4BC4930628")
    ...
    static var whisperService: CBMutableService = {
        ...
        service.characteristics = [whisperNameCharacteristic]
        return service
    }()
}
